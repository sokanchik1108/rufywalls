...
<head>
    ...
    <style>
        ...
        .variant-group, .batch-group { background: #f9f9f9; padding: 15px; border-radius: 5px; position: relative; }
        .remove-variant, .remove-batch { position: absolute; top: 10px; right: 10px; }
    </style>
</head>
<body class="bg-light">
