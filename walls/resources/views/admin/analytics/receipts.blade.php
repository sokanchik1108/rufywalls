...
<head>
    ...
    <style>
        * {
        ...
        /*
         * Вертикальное выравнивание даты
        ...
        @media (max-width: 600px) {
            ...
            /*
             * От и По в одной строке.
             *
             * Поля немного уже, чем половина строки,
             * чтобы был аккуратный запас и они не выступали.
             */
...
<div class="page">
    ...
    @php
        ...
        foreach ($dailyStats as $day) {
            ...
            $weekdayStats[$weekday]['receipts']
                += (int) $day['receipts'];

            $weekdayStats[$weekday]['quantity']
                += (int) $day['quantity'];
        }
                ...
                @foreach($weekdayNames as $dayNumber => $dayName)
                    ...
                    <div class="weekday-card">
                        ...
                        <div class="weekday-value">
                            {{ number_format(
                                $weekdayStats[$dayNumber]['receipts'],
                                0,
                                '.',
                                ' '
                            ) }}
                        ...
                        <div class="weekday-products">
                            ...
                            {{ number_format(
                                $weekdayStats[$dayNumber]['quantity'],
                                0,
                                '.',
                                ' '
                            ) }}
    ...
    <div class="section">
        ...
        <div class="section-note">
            ...
            Средний завоз = общее количество завезённого товара
            ÷ количество приёмок
