        ...
        <div class="card mb-3 shadow-sm border-0 rounded-4 order-card">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between">
                    ...
                    <span>{{ number_format($order->items->sum(fn($i)=>$i->price*$i->quantity),0,',',' ') }} ₸</span>
                </div>
                <div class="mt-2">
                    ...
                    <div class="container-fluid">
                        <div class="row mb-3">
                            <div class="col-12 mb-3">
                                ...
                                <div class="p-3 bg-light rounded-3 shadow-sm mt-2">
                        ...
                        <div class="mt-4 text-end fw-bold fs-5">
                            Общая сумма: {{ number_format($order->items->sum(fn($i)=>$i->price*$i->quantity),0,',',' ') }} ₸
                        </div>
                    </div>
                </div>
            </div>
