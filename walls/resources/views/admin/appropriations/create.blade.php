...
<head>
    ...
    <title>Новое оприходование</title>
...
<div class="page">
    ...
    <div class="top">
        ...
        <div class="title-block">
            ...
            <div class="page-subtitle">
                Добавление товара на склад без приёмки
            </div>
    ...
    <form
        method="POST"
        action="{{ route('admin.appropriations.store') }}"
                ...
                <div class="info-grid">
                    ...
                    <div class="field">
                        ...
                        <input
                            ...
                            class="field-input"
                            value="{{ old('appropriation_date', now('Asia/Almaty')->format('Y-m-d')) }}"
                            required>
                ...
                <div class="items-head">
                    ...
                    <div>
                        ...
                        <div class="section-description">
                            Артикул, партия, количество и цена последней приёмки
                        </div>
...
<script>
    ...
    /*
     * Контроллер должен передать $variants
     * в том же формате, что и страница приёмки:
     *
     * [
     *     {
     *         id,
     ...
     * ]
     *
     * purchase_price здесь = цена последней приёмки.
     */
    ...
    function variantChanged(select) {
        ...
        /*
         * Цена последней приёмки.
         * Пользователь её изменить не может.
         */
        ...
        .addEventListener(
            ...
            function(e) {
                ...
                if (!valid) {
                    ...
                    alert(
                        'Проверьте артикул, партию, количество и цену последней приёмки.'
                    );
