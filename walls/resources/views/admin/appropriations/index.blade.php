...
<body>
    ...
    ========================= */
        ...
        @media (max-width: 700px) {
            ...
            /* От/До на одной строке (равная ширина), Склад — на своей
               отдельной строке на всю ширину. overflow:hidden не даёт
               тексту даты вылезать на соседнее поле. */
            .filters {
                display: grid;
                grid-template-columns: repeat(2, minmax(0, 1fr));
                gap: 8px;
        ...
        @media (max-width: 480px) {
            ...
            /*
             * От/До на одной строке (равная ширина), Склад — на своей
             * отдельной строке на всю ширину, даже на самых узких экранах.
             */
            .filters {
                display: grid;
                grid-template-columns: repeat(2, minmax(0, 1fr));
