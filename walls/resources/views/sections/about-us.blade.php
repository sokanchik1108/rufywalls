<section class="about-section py-5" id="about-us" style="padding-top:10rem; padding-bottom:10rem;">
    <div class="container px-3 px-md-4" style="max-width: 1000px; margin-top:1rem; margin-bottom:1rem;">
        ...
        <div class="section-text" data-aos="fade-up" data-aos-delay="100"
            style="font-weight: 500; font-size: 1rem; line-height: 1.6;">
            <p>
...
<style>
    ...
    .section-title {
        font-size: 1.4rem !important; /* уменьшенный размер для телефонов */
    }

    .company-name {
        font-size: 1.5rem !important; /* чуть меньше для мобильных */
    }
}
</style>