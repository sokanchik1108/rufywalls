...
.rafy-card-lux {
    position: relative;
    border-radius: 17.6px; /* было 22px */
    overflow: hidden;
...
.rafy-overlay-content {
    ...
    border-radius: 12.8px; /* было 16px */
    padding: 16px 20px;
    width: 100%;
    max-width: 85%;
}
...
/* Кнопка */
.rafy-btn-glass {
    padding: 8px 24px; /* было 10px 30px */
    border-radius: 24px;
    font-size: 0.76rem; /* было 0.95rem */
    font-weight: 600;
    color: #fff;
    background-color: #01142f;
